...
wombatmail: $(OBJECTS)
	g++ -O3 -o wombatmail $(OBJECTS) -lX11 -lXext -lXft -lfontconfig -lfreetype -lXcursor -lXrender -lXrandr -lXfixes -lXi -lGLU -lGL -ldl -lpthread -ljpeg -lrt -lpng -ltiff -lz -lbz2 -lcrypto -lgsasl -lgnutls -licuuc libFOX-1.7.a libpff.a libvmime.a liblexbor_static.a
