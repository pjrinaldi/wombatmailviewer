OBJECTS = icons.o wombatmail.o managetags.o aboutbox.o viewer.o parsemsg.o cfb.o msg.o
...
wombatmail.o: wombatmail.cpp icons.h managetags.cpp aboutbox.cpp viewer.cpp parsemsg.cpp cfb.cpp msg.cpp
